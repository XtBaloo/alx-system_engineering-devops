@if(session('success') || session('error') || session('info'))
    <div
        ...
        x-show="show"
        x-transition
        class="mb-4 flex items-start justify-between gap-3 rounded-md border px-4 py-3 text-sm shadow-sm print:hidden
...
@if ($errors->any())
    <div class="mb-4 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 print:hidden">
